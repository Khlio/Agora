...
public class AnnexeRessourceTest {

	@Before
	public void setUp() {
		busCommande = mock(BusCommande.class);
		when(busCommande.envoie(any(Message.class))).thenReturn(null);
		ressource = new AnnexeRessource(busCommande);
	}
	
	@Test
	public void peutSupprimerUnFichierAnnexe() throws IOException {
	...
	private AnnexeRessource ressource;
