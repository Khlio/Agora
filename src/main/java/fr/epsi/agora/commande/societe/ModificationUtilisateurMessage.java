...
public class ModificationUtilisateurMessage implements Message {
	...
	public ModificationUtilisateurMessage(UUID id, String nom, String prenom, String email, String motDePasse, String adresse, String codePostal, String telephone) {
		this.id = id;
		this.nom = nom;
		this.prenom = prenom;
		this.email = email;
