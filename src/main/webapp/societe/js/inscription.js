...
function valider(formulaire){
	...
	var codePostal = formulaire.elements['inputCodePostal'].value;
	...
	formulaire.elements['inputMDP'].value = md5('43bcad2f5fca1db55ca5d89d0f005b59'+formulaire.elements['inputMDP'].value);
	
	outils.ajaxRequestPlus((outils.url+'/societes/'+formulaire.elements['inputSociete'].value),"PUT",$('#inscription').serialize(),function(donnees){
		document.location.href="societe.html?id="+formulaire.elements['inputSociete'].value;
	});
