...
//sérialize un object pour pouvoir former un json
...
{
    outils.ajaxRequestPlus((outils.url+'/utilisateurs/' + $.cookie('bouh') + '/constats',"PUT",$("#SignupForm").serialize(),function(donnees){
